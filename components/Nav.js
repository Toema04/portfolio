...
const Nav = () => {
  ...
  return (
    ...
    bottom-0 mt-auto xl:right-[1%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen '>
      {/* inner */}
      <div className='flex max-w-[100%] gap-x-10 xl:flex-col w-full items-center justify-between
