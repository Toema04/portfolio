      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex flex-1 flex-col justify-center">
          ...
          <motion.div
            ...
            animate='show'
            exit='hidden'
            className="hidden md:flex xl:gap-x-6 md:max-w-xl xl:max-w-none mx-auto xl:mx-0 md:mb-5 xl:mb-8 ">
            <div className="flex flex-2 gap-x-10">
              {/* experience */}
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 
              after:absolute after:top-0 after:right-0 after:left-[120px] pb-3 ">
                <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2 ">
                  <CountUp start={0} end={3} duration={1} /> +
                </div>
                <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px] cursor-default">Years of experience</div>
              </div>
              {/* clients */}
              {/* <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 
              ...
              after:absolute after:top-0 after:right-0">
                ...
                <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px] cursor-default">
                  Finished Projects
                </div>
              </div>
              {/* awards */}
        ...
        <motion.div
          ...
          animate='show'
          exit='hidden'
          className="flex flex-col w-full xl:max-w-[48%] xl:h-[400px] xl:mt-3">
          <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 md:mb-2 xl:mb-4">
          ...
          <div className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start">
            {aboutData[index].info.map((item, itemIcon) => {
              return (<>
                <div key={itemIcon} className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-white/60 cursor-default">
                  {/* title */}
